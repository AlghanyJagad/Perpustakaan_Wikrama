<ul class="nav">
          ...
          <li class="nav-item {{ request()->routeIs(['anggota*', 'buku*', 'user*']) ? 'active' : '' }}">
            <a class="nav-link " data-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <i class="menu-icon mdi mdi-content-copy"></i>
              <span class="menu-title">Master Data</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse {{ request()->routeIs(['anggota*', 'buku*', 'user*']) ? 'show' : '' }}" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('anggota*') ? 'active' : '' }}" href="{{route('anggota.index')}}">Data Anggota</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('buku*') ? 'active' : '' }}" href="{{route('buku.index')}}">Data Buku</a>
                </li>
                 <li class="nav-item">
                  <a class="nav-link {{ request()->routeIs('user*') ? 'active' : '' }}" href="{{route('user.index')}}">Data User</a>
                </li>
              </ul>
            </div>
          </li>
